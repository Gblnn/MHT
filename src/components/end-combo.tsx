    ...
    return (
      <Select value={props.value} required onValueChange={props.onChange}>
        ...
        <SelectContent style={{ background: "#1a1a1a", color: "white" }}>
          ...
          <SelectItem value="10:30">8:30</SelectItem>
          <SelectItem value="11:00">9:00</SelectItem>
          <SelectItem value="11:30">9:30</SelectItem>
          <SelectItem value="12:00">10:00</SelectItem>
          <SelectItem value="12:30">10:30</SelectItem>
